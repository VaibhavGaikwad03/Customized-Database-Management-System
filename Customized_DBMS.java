        ...
        while(true)
        {
            ...
            if(QuerySize == 1)
            {
                if("help".equals(tokens[0]))
                {
                    ...
                    System.out.println("Query : update into student set name = student_name where rid = student_rid \nUse : To update the existing data(Name)\n");
                    System.out.println("Query : update into student set salary = student_salary where rid = student_rid \nUse : To update the existing data(Salary)\n");
                        ...
                        if("student".equals(tokens[2]))
                        {
                            if("where".equals(tokens[3]))
                            {
                                ...
                                else if("rid".equals(tokens[4]))
                                {
                                    if("=".equals(tokens[5]))
                                    {
                                        if(Student.Generator >= Integer.parseInt(tokens[6]))
                                        {
                                        ...
                                        {
                                            System.out.println("Please enter valid RID !!!");
                                        }
                                    }
                                    else
                                    {
                                        ...
                                        if("where".equals(tokens[7]))
                                        {
                                            if("rid".equals(tokens[8]))
                                            {
                                                if("=".equals(tokens[9]))
                                                {
                                                    ...
                                                    if(Student.Generator >= Integer.parseInt(tokens[10]))
                                                    {
...
##  Input : int, String
##  Output : None
##  Description : It is used to update existing data(Name)
##  Author : Vaibhav Tukaram Gaikwad
##  Date : 27-07-2022
##
##############################################################################
...
##############################################################################
##
##  Function name : UpadteSalary
##  Input : int, int
##  Output : None
##  Description : It is used to update existing data(Salary)
##  Author : Vaibhav Tukaram Gaikwad
##  Date : 27-07-2022
##
##############################################################################
